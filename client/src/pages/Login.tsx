    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-orange-50 flex items-center justify-center p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center space-y-2">
          ...
          <CardTitle className="text-2xl font-bold" style={{ fontFamily: "Montserrat, sans-serif", color: "#2C5CDC" }}>
            Admin Login
          </CardTitle>
          <p className="text-gray-600" style={{ fontFamily: "Montserrat, sans-serif" }}>
            Done For You Pros Dashboard
          </p>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-2">
              <Label htmlFor="username" style={{ fontFamily: "Montserrat, sans-serif" }}>
                Email Address
              </Label>
              <Input
                id="username"
            ...
            <Button
              type="submit"
              className="w-full bg-gradient-to-r from-blue-600 to-orange-500 hover:from-blue-700 hover:to-orange-600 text-white font-semibold py-2 px-4 rounded-lg transition-all duration-200"
